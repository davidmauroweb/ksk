...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-header text-center">Gestión de Categorías
                </div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <td>{{$i->nombre}}</td>
                            <td>{{$i->total}}</td>
                            <td><a href="{{route ('arts', ['c', $i->id])}}"><button class="btn btn-sm btn-success" title="Arts. de {{$i->nombre}}"><i class="bi bi-list-columns-reverse"></i></button></a></td>
                            <td>
